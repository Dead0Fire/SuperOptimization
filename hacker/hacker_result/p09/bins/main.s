...
.main:                   #        0x4004d0  0      OPC=<label>         
  ...
  jle .L_400566          #  8     0x4004df  6      OPC=jle_label_1     
...
.L_400517:               #        0x400517  0      OPC=<label>         
  ...
  jle .L_400559          #  26    0x40051f  2      OPC=jle_label       
.L_400521:               #        0x400521  0      OPC=<label>         
  xorl %ebx, %ebx        #  27    0x400521  2      OPC=xorl_r32_r32    
  jmpq .L_40053b         #  28    0x400523  2      OPC=jmpq_label      
...
.L_400528:               #        0x400528  0      OPC=<label>         
  ...
  addl $0x1, %ebx        #  33    0x40052d  3      OPC=addl_r32_imm8   
  movl %eax, %edi        #  34    0x400530  2      OPC=movl_r32_r32    
  callq ._Z3p09i         #  35    0x400532  5      OPC=callq_label     
  cmpl %ebp, %ebx        #  36    0x400537  2      OPC=cmpl_r32_r32    
  jge .L_400559          #  37    0x400539  2      OPC=jge_label       
.L_40053b:               #        0x40053b  0      OPC=<label>         
  callq .rand_plt        #  38    0x40053b  5      OPC=callq_label     
  testb $0x1, %al        #  39    0x400540  2      OPC=testb_al_imm8   
  jne .L_400528          #  40    0x400542  2      OPC=jne_label       
  callq .rand_plt        #  41    0x400544  5      OPC=callq_label     
  negl %eax              #  42    0x400549  2      OPC=negl_r32        
  addl $0x1, %ebx        #  43    0x40054b  3      OPC=addl_r32_imm8   
  movl %eax, %edi        #  44    0x40054e  2      OPC=movl_r32_r32    
  callq ._Z3p09i         #  45    0x400550  5      OPC=callq_label     
  cmpl %ebp, %ebx        #  46    0x400555  2      OPC=cmpl_r32_r32    
  jl .L_40053b           #  47    0x400557  2      OPC=jl_label        
.L_400559:               #        0x400559  0      OPC=<label>         
  addq $0x8, %rsp        #  48    0x400559  4      OPC=addq_r64_imm8   
  xorl %eax, %eax        #  49    0x40055d  2      OPC=xorl_r32_r32    
  popq %rbx              #  50    0x40055f  1      OPC=popq_r64_1      
  popq %rbp              #  51    0x400560  1      OPC=popq_r64_1      
  popq %r12              #  52    0x400561  2      OPC=popq_r64_1      
  popq %r13              #  53    0x400563  2      OPC=popq_r64_1      
  retq                   #  54    0x400565  1      OPC=retq            
.L_400566:               #        0x400566  0      OPC=<label>         
  xorl %edi, %edi        #  55    0x400566  2      OPC=xorl_r32_r32    
  movl $0x400, %ebp      #  56    0x400568  5      OPC=movl_r32_imm32  
  callq .srand_plt       #  57    0x40056d  5      OPC=callq_label     
  jmpq .L_400521         #  58    0x400572  2      OPC=jmpq_label      
